...
rem ============================================================
rem  market-watch init script (Windows)
...
env\Scripts\python.exe -c "import fastapi, uvicorn, akshare, baostock, pandas, openai, apscheduler, tzdata, dotenv; print('  imports OK')"
if errorlevel 1 (
