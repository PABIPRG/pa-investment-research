#!/usr/bin/env bash
# ============================================================
#  dsh-trading-core 初始化脚本（macOS / Linux）
...
# ---------- 6. 验证关键导入 ----------
echo "[验证] 关键依赖导入检查 ..."
env/bin/python -c "import fastapi, uvicorn, akshare, langgraph, chromadb, sse_starlette; print('  imports OK')"
