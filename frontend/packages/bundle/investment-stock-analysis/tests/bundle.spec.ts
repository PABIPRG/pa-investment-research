...
describe('investment stock analysis bundle', () => {
  it('publishes a patch containing only its dependency-backed business row', () => {
    ...
    expect(manifest.name).toBe('@deepseek-ai/dsh-investment-stock-analysis-bundle')
    ...
    expect(manifest.dependencies).toHaveProperty('@deepseek-ai/dsh-investment-stock-analysis')
