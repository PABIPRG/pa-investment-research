...
- **The starter MIME table is minimal** — it covers the Vite-emitted asset set plus PNG/ICO application icons and the shipped PWA manifest; other extensions fall back to `application/octet-stream` until an asset class actually ships.
