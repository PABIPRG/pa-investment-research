...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('remote-rejected'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('resource-exhausted'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('resource-expired'), message: z.string(), details: z.object({}) }),
