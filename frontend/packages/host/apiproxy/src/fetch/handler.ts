...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'modelAdmin.describe': { schema: settingsDescribeRequestSchema, invoke: (api, r) => api.modelAdmin.describe(r) },
  'modelAdmin.mutate': { schema: settingsMutateRequestSchema, invoke: (api, r) => api.modelAdmin.mutate(r) },
  'modelAdmin.describeCredentials': { schema: credentialsDescribeRequestSchema, invoke: (api, r) => api.modelAdmin.describeCredentials(r) },
  'modelAdmin.setCredential': { schema: credentialsSetRequestSchema, invoke: (api, r) => api.modelAdmin.setCredential(r) },
  'modelAdmin.unsetCredential': { schema: credentialsUnsetRequestSchema, invoke: (api, r) => api.modelAdmin.unsetCredential(r) },
  'modelAdmin.discoverModels': { schema: llmDiscoverModelsRequestSchema, invoke: (api, r, signal) => api.modelAdmin.discoverModels(r, signal) },
