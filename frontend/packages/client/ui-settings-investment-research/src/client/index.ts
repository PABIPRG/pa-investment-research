...
export function apply(ctx: ClientContext): void {
  ...
  const injected = (): InvestmentReadinessSectionInjected => ({
    ...
    backupDownloadBegin: (filename, signal) => runtime.backupDownloadBegin(filename, signal),
    backupDownloadChunk: (input, signal) => runtime.backupDownloadChunk(input, signal),
    backupDownloadCancel: id => runtime.backupDownloadCancel(id),
    backupPreviewStored: (filename, signal) => runtime.backupPreviewStored(filename, signal),
    backupUploadBegin: (input, signal) => runtime.backupUploadBegin(input, signal),
    backupUploadChunk: (input, signal) => runtime.backupUploadChunk(input, signal),
    backupUploadInspect: (id, signal) => runtime.backupUploadInspect(id, signal),
    backupUploadCancel: id => runtime.backupUploadCancel(id),
    backupPreviewCancel: id => runtime.backupPreviewCancel(id),
