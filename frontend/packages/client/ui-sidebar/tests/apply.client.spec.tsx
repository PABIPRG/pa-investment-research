...
describe('ui-sidebar apply', () => {
  ...
  it('registers the shell and declares its child seats', async () => {
    ...
    expect(b.slots.spec('sidebar.newSession')).toEqual({ kind: 'single', scope: 'root' })
    expect(b.slots.entries('sidebar.newSession')).toHaveLength(1)
  ...
  it('removes the entry and child declaration on teardown', async () => {
    ...
    expect(b.slots.spec('sidebar.newSession')).toBeUndefined()
