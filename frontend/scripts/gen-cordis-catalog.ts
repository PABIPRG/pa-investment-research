...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  investmentPythonRuntime: 'investment-research.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsUi: 'client-side Settings navigation request service — packages/client/ui-settings/README.md owns the API',
  ...
  webAuth: 'optional Web-only transport authority — packages/api/web-auth/README.md owns the API',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  BackupDescription: 'investment-research.md',
  ...
  PythonBackendLease: 'investment-research.md',
  DeploymentCapabilitySnapshot: '../deployment-capabilities.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  InvestmentBackendManager: 'service-local lifecycle snapshot implementation is owned by packages/investment-research/python-runtime/src/runtime.ts',
  BackupCategory: 'backup archive contract is owned by packages/investment-research/python-runtime/src/backup-archive.ts',
  BackupConflictRule: 'backup archive contract is owned by packages/investment-research/python-runtime/src/backup-archive.ts',
  BackupListItem: 'backup archive contract is owned by packages/investment-research/python-runtime/src/backup-archive.ts',
  BackupManifest: 'backup archive contract is owned by packages/investment-research/python-runtime/src/backup-archive.ts',
  BackupPreview: 'backup archive contract is owned by packages/investment-research/python-runtime/src/backup-archive.ts',
  BackupReason: 'backup archive contract is owned by packages/investment-research/python-runtime/src/backup-archive.ts',
