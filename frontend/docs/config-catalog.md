...
Source: [`packages/client/modules/src/index.ts:47`](../packages/client/modules/src/index.ts)
...
Requires: `tools` · `investmentPythonRuntime`
...
Source: [`packages/investment-research/market-watch/src/index.ts:41`](../packages/investment-research/market-watch/src/index.ts)
...
Source: [`packages/investment-research/python-runtime/src/types.ts:46`](../packages/investment-research/python-runtime/src/types.ts)

<a id="deepseek-aidsh-investment-stock-analysis"></a>

## `@deepseek-ai/dsh-investment-stock-analysis`

Requires: `tools` · `agents` · `investmentPythonRuntime`
...
Source: [`packages/investment-research/stock-analysis/src/index.ts:47`](../packages/investment-research/stock-analysis/src/index.ts)
