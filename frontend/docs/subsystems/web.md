...
<a id="ctxdeploymentcapabilities--deploymentcapabilities"></a>

### `ctx.deploymentCapabilities` — `DeploymentCapabilities`
 ...
 */
snapshot(): DeploymentCapabilitySnapshot
```

Types: [DeploymentCapabilitySnapshot](../deployment-capabilities.md)

Source: [`packages/host/deployment-capabilities/src/index.ts:53`](../../packages/host/deployment-capabilities/src/index.ts)
