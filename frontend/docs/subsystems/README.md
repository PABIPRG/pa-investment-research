...
| [investment-research.md](investment-research.md) | investment Python backend definitions, identity-aware health checks, managed/external ownership, reference-counted leases, and owner-only diagnostics |
